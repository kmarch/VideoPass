...
<html>
	...
	<body>
		<a href="#edit-commentaire" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-commentaire" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:commentaireInstance, action:'update']" method="PUT" >
